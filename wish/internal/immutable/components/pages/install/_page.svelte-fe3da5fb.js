import{S as st,i as nt,s as ot,a as W,k as r,q as Y,X as at,h as n,c as C,l as c,m as u,r as q,n as a,F as B,ab as K,b as Q,G as t,O as H,Y as Z,A as $,C as lt,P as x,o as it}from"../../../chunks/index-ba3787f6.js";import{Y as rt}from"../../../chunks/runtime.esm-ee3b0ca4.js";import{A as tt}from"../../../chunks/env-164b308d.js";import{i as ct}from"../../../chunks/app-stores-9073b00a.js";const ut=`<h1>How To Install WishSimulator.App to your <span> Android Phone</span></h1>
...
`;function ht(s){let _,p,e,m,g,l,I,E,h,i,k,f,M,d,S,N,P,b,T,j,A,y,D,F,R;return document.title=_=`\r
		Install Instruction | `+s[2]("title",{default:tt})+`\r
	`,{c(){p=W(),e=r("section"),m=r("header"),g=r("div"),l=r("a"),I=Y("WishSimulator.App"),E=W(),h=r("div"),i=r("button"),k=r("i"),f=Y(" Android"),M=W(),d=r("button"),S=r("i"),N=Y(" Windows"),P=W(),b=r("article"),j=W(),A=r("footer"),y=r("a"),D=Y("Start Wishing Now !"),this.h()},l(o){at('[data-svelte="svelte-12rceiw"]',document.head).forEach(n),p=C(o),e=c(o,"SECTION",{class:!0});var w=u(e);m=c(w,"HEADER",{class:!0});var U=u(m);g=c(U,"DIV",{class:!0});var J=u(g);l=c(J,"A",{href:!0});var V=u(l);I=q(V,"WishSimulator.App"),V.forEach(n),J.forEach(n),U.forEach(n),E=C(w),h=c(w,"DIV",{class:!0});var O=u(h);i=c(O,"BUTTON",{class:!0});var G=u(i);k=c(G,"I",{class:!0}),u(k).forEach(n),f=q(G," Android"),G.forEach(n),M=C(O),d=c(O,"BUTTON",{class:!0});var L=u(d);S=c(L,"I",{class:!0}),u(S).forEach(n),N=q(L," Windows"),L.forEach(n),O.forEach(n),P=C(w),b=c(w,"ARTICLE",{class:!0});var et=u(b);et.forEach(n),j=C(w),A=c(w,"FOOTER",{class:!0});var z=u(A);y=c(z,"A",{href:!0,class:!0});var X=u(y);D=q(X,"Start Wishing Now !"),X.forEach(n),z.forEach(n),w.forEach(n),this.h()},h(){a(l,"href","/"),a(g,"class","brand"),a(m,"class","svelte-y6ol5v"),a(k,"class","gi-android svelte-y6ol5v"),a(i,"class","svelte-y6ol5v"),B(i,"active",s[0]==="android"),a(S,"class","gi-windows svelte-y6ol5v"),a(d,"class","svelte-y6ol5v"),B(d,"active",s[0]==="windows"),a(h,"class","select-device svelte-y6ol5v"),a(b,"class",T=K(s[0])+" svelte-y6ol5v"),a(y,"href","/"),a(y,"class","svelte-y6ol5v"),a(A,"class","svelte-y6ol5v"),a(e,"class","svelte-y6ol5v")},m(o,v){Q(o,p,v),Q(o,e,v),t(e,m),t(m,g),t(g,l),t(l,I),t(e,E),t(e,h),t(h,i),t(i,k),t(i,f),t(h,M),t(h,d),t(d,S),t(d,N),t(e,P),t(e,b),b.innerHTML=s[1],t(e,j),t(e,A),t(A,y),t(y,D),F||(R=[H(l,"click",Z(s[4])),H(i,"click",s[5]),H(d,"click",s[6]),H(y,"click",Z(s[7]))],F=!0)},p(o,[v]){v&4&&_!==(_=`\r
		Install Instruction | `+o[2]("title",{default:tt})+`\r
	`)&&(document.title=_),v&1&&B(i,"active",o[0]==="android"),v&1&&B(d,"active",o[0]==="windows"),v&2&&(b.innerHTML=o[1]),v&1&&T!==(T=K(o[0])+" svelte-y6ol5v")&&a(b,"class",T)},i:$,o:$,d(o){o&&n(p),o&&n(e),F=!1,lt(R)}}}function dt(s,_,p){let e,m,g;x(s,ct,f=>p(8,m=f)),x(s,rt,f=>p(2,g=f));let l="windows";const I=f=>{p(0,l=f)};it(()=>{if(m)return p(0,l="android")});const E=()=>window.location.replace("/"),h=()=>I("android"),i=()=>I("windows"),k=()=>window.location.replace("/");return s.$$.update=()=>{s.$$.dirty&1&&p(1,e=l==="android"?ut:pt)},[l,e,g,I,E,h,i,k]}class bt extends st{constructor(_){super(),nt(this,_,dt,ht,ot,{})}}export{bt as default};
