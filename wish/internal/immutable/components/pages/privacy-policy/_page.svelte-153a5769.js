import{S as H,i as q,s as G,a as b,k as p,q as I,X as L,h as o,c as S,l as y,m as d,r as W,n as u,b as k,G as a,A,P as O}from"../../../chunks/index-ba3787f6.js";import{Y as R}from"../../../chunks/runtime.esm-ee3b0ca4.js";import{A as C}from"../../../chunks/env-164b308d.js";const $=`<h2>Privacy Policy</h2>
...
`;function N(m){let s,r,e,t,n,P,w,l,g,_,c;return document.title=s=`\r
		Privacy Policy | `+m[0]("title",{default:C})+`\r
	`,{c(){r=b(),e=p("section"),t=p("header"),n=p("h1"),P=I("Privacy Policy for WishSimulator.App"),w=b(),l=p("h2"),g=I("Genshin Impact Wish Simulator"),_=b(),c=p("article"),this.h()},l(i){L('[data-svelte="svelte-avd0f7"]',document.head).forEach(o),r=S(i),e=y(i,"SECTION",{class:!0});var v=d(e);t=y(v,"HEADER",{class:!0});var f=d(t);n=y(f,"H1",{class:!0});var T=d(n);P=W(T,"Privacy Policy for WishSimulator.App"),T.forEach(o),w=S(f),l=y(f,"H2",{class:!0});var E=d(l);g=W(E,"Genshin Impact Wish Simulator"),E.forEach(o),f.forEach(o),_=S(v),c=y(v,"ARTICLE",{class:!0});var x=d(c);x.forEach(o),v.forEach(o),this.h()},h(){u(n,"class","svelte-15i5hk1"),u(l,"class","svelte-15i5hk1"),u(t,"class","svelte-15i5hk1"),u(c,"class","svelte-15i5hk1"),u(e,"class","svelte-15i5hk1")},m(i,h){k(i,r,h),k(i,e,h),a(e,t),a(t,n),a(n,P),a(t,w),a(t,l),a(l,g),a(e,_),a(e,c),c.innerHTML=$},p(i,[h]){h&1&&s!==(s=`\r
		Privacy Policy | `+i[0]("title",{default:C})+`\r
	`)&&(document.title=s)},i:A,o:A,d(i){i&&o(r),i&&o(e)}}}function U(m,s,r){let e;return O(m,R,t=>r(0,e=t)),[e]}class M extends H{constructor(s){super(),q(this,s,U,N,G,{})}}export{M as default};
